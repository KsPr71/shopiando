...
const styles = StyleSheet.create({
  ...
  avatarEditButton: { alignItems: 'center', borderRadius: 14, bottom: 2, boxShadow: '0px 2px 4px rgba(0, 0, 0, 0.20)', height: 28, justifyContent: 'center', position: 'absolute', right: 2, width: 28 },
  ...
  infoCard: { borderRadius: Spacing.five, boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.12)', gap: Spacing.three, marginHorizontal: Spacing.three, marginTop: -Spacing.four, padding: Spacing.four },
