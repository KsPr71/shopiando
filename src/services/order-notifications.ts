...
export async function createOrderCompletionNotification(..._args: unknown[]): Promise<void> {}
export async function createOrderCancellationNotification(..._args: unknown[]): Promise<void> {}
